...
class ContentTwo: UIViewController, ModalView {
    private let titleLabel: UILabel = {
        let label = UILabel()
        label.text = "Different heading"
    ...
    private let bodyText: UILabel = {
        let label = UILabel()
        label.text = "Here's a lot more text. Lorem ipsum dolor amet. Lorem ipsum dolor amet. Lorem ipsum dolor amet. Lorem ipsum dolor amet. Lorem ipsum dolor amet. Lorem ipsum dolor amet. Lorem ipsum dolor amet. Lorem ipsum dolor amet.\n\nThis is some example text that spans over multiple lines. Bla bla bla test test test many words. This is a new sentance and we'll see how that fares too."
    ...
    func preferredHeight(for _: CGFloat) -> CGFloat { 470 }
}
