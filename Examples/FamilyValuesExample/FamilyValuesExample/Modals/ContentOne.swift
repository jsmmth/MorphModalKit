...
class ContentOne: UIViewController, ModalView {
    private let titleLabel: UILabel = {
        let label = UILabel()
        label.text = "This is a test title"
    ...
    private let bodyText: UILabel = {
        let label = UILabel()
        label.text = "This is some example text that spans over multiple lines. Bla bla bla test test test many words. This is a new sentance and we'll see how that fares too."
